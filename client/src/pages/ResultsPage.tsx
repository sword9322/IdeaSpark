        ...
        <main className="flex-grow">
          <div className="container mx-auto max-w-[600px] px-4 py-8">
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <p className="text-gray-600 mt-2">We couldn't load the requested ideas. Please try again.</p>
              <button 
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <div className="container mx-auto max-w-[600px] px-4 py-8">
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <div className="mb-6 pb-4 border-b border-gray-100">
              <h2 className="text-lg font-medium text-gray-800 mb-1">Your request:</h2>
